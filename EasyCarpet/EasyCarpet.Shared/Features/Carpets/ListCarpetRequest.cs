...
namespace EasyCarpet.Shared.Features.Carpets
{
    ...
    public record ListCarpetDto(Guid Id, string Name, decimal Width, decimal Length, decimal SquareYardPrice, string Brand, string Style, string Description, string ImageFileName);
}