...
namespace EasyCarpet.Domain.Migrations
{
    ...
    [Migration("20210518200604_AddedCustomers")]
            ...
            modelBuilder.Entity("EasyCarpet.Domain.Models.Carpet", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2021, 5, 18, 16, 6, 4, 316, DateTimeKind.Local).AddTicks(2114),
                            Description = "Medium Beige / Dark Beige flecks, indoor residential",
                            Image = "TrafficMasterBrown.jpg",
                            Length = 200m,
                            ModifiedDate = new DateTime(2021, 5, 18, 16, 6, 4, 318, DateTimeKind.Local).AddTicks(7320),
            ...
            modelBuilder.Entity("EasyCarpet.Domain.Models.Installer", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Area = 0m,
                            CreatedDate = new DateTime(2021, 5, 18, 16, 6, 4, 320, DateTimeKind.Local).AddTicks(9173),
                            FirstName = "Sean",
                            LastName = "Warchuck",
                            ModifiedDate = new DateTime(2021, 5, 18, 16, 6, 4, 320, DateTimeKind.Local).AddTicks(9190),
            ...
            modelBuilder.Entity("EasyCarpet.Domain.Models.Retailer", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2021, 5, 18, 16, 6, 4, 320, DateTimeKind.Local).AddTicks(4671),
                            Description = "A large box chain retailer with good prices",
                            ModifiedDate = new DateTime(2021, 5, 18, 16, 6, 4, 320, DateTimeKind.Local).AddTicks(4700),
