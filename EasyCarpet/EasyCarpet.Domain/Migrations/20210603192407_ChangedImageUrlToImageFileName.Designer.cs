...
namespace EasyCarpet.Domain.Migrations
{
    ...
    [Migration("20210603192407_ChangedImageUrlToImageFileName")]
    partial class ChangedImageUrlToImageFileName
    {
            ...
            modelBuilder.Entity("EasyCarpet.Domain.Models.Carpet", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2021, 6, 3, 15, 24, 7, 221, DateTimeKind.Local).AddTicks(9925),
                            Description = "Medium Beige / Dark Beige flecks, indoor residential",
                            Length = 200m,
                            ModifiedDate = new DateTime(2021, 6, 3, 15, 24, 7, 224, DateTimeKind.Local).AddTicks(9583),
            ...
            modelBuilder.Entity("EasyCarpet.Domain.Models.Customer", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            City = "Livonia",
                            CreatedDate = new DateTime(2021, 6, 3, 15, 24, 7, 227, DateTimeKind.Local).AddTicks(5848),
                            FirstName = "Kyle",
                            LastName = "Warchuck",
                            ModifiedDate = new DateTime(2021, 6, 3, 15, 24, 7, 227, DateTimeKind.Local).AddTicks(5864),
            ...
            modelBuilder.Entity("EasyCarpet.Domain.Models.Installer", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Area = 0m,
                            CreatedDate = new DateTime(2021, 6, 3, 15, 24, 7, 227, DateTimeKind.Local).AddTicks(2165),
                            FirstName = "Sean",
                            LastName = "Warchuck",
                            ModifiedDate = new DateTime(2021, 6, 3, 15, 24, 7, 227, DateTimeKind.Local).AddTicks(2183),
            ...
            modelBuilder.Entity("EasyCarpet.Domain.Models.Order", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2021, 6, 3, 15, 24, 7, 227, DateTimeKind.Local).AddTicks(9560),
                            CustomerId = new Guid("14999486-bc73-4651-be18-fa308608831d"),
                            InstallerId = new Guid("ebb89a92-dd6a-43ef-9301-3a58c479120a"),
                            ModifiedDate = new DateTime(2021, 6, 3, 15, 24, 7, 227, DateTimeKind.Local).AddTicks(9575),
                            RetailerId = new Guid("943ba50f-41c5-4881-9a97-7e4de399836d"),
                            Total = 100m
                        });
                });
            ...
            modelBuilder.Entity("EasyCarpet.Domain.Models.Retailer", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2021, 6, 3, 15, 24, 7, 226, DateTimeKind.Local).AddTicks(7428),
                            Description = "A large box chain retailer with good prices",
                            ModifiedDate = new DateTime(2021, 6, 3, 15, 24, 7, 226, DateTimeKind.Local).AddTicks(7475),
